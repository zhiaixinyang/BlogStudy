 ...
 * 如果加注解：class KotlinNote private @Inject constructor 此时必须要存在
 *
 ...
 */
abstract class KotlinNote constructor(override val name: String, val age: Int) : BaseKotlinNote() {
    /**
     *  位运算符使用：
     *
     *  Java：
