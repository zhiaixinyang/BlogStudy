package blog.com.blogstudy.pullextend;
...
import blog.com.blogstudy.utils.DensityUtil;
...
public class ExtendListFooter extends ExtendLayout {
    ...
    public ExtendListFooter(Context context, AttributeSet attrs) {
        super(context, attrs);
        containerHeight = DensityUtil.dip2px(context, 60);
        listHeight = DensityUtil.dip2px(context, 100);
    }

    @Override
    protected void bindView(View container) {
        mRecyclerView = (RecyclerView) findViewById(R.id.list);
        mExpendPoint = (ExpendPoint) findViewById(R.id.expend_point);
    }
