package blog.com.blogstudy.view.xiaomi;
...
public class ChaosCompassView extends View {
    ...
    private void drawCompassCircum() {
        ...
        RectF rectF1=new RectF(width / 2 - mCircumRadius, mTextHeight + mOutSideRadius - mCircumRadius,
                width / 2 + mCircumRadius, mTextHeight + mOutSideRadius + mCircumRadius);
        mCanvas.drawArc(rectF1, -85, 350, false, mDeepGrayPaint);
        mAnglePaint.setStrokeWidth(5f);
        if (val <= 180) {
            RectF rectF2=new RectF(width / 2 - mCircumRadius, mTextHeight + mOutSideRadius - mCircumRadius,
                    width / 2 + mCircumRadius, mTextHeight + mOutSideRadius + mCircumRadius);
            valCompare = val;
            mCanvas.drawArc(rectF2, -85, valCompare, false, mAnglePaint);
        } else {
            RectF rectF3=new RectF(width / 2 - mCircumRadius, mTextHeight + mOutSideRadius - mCircumRadius,
                    width / 2 + mCircumRadius, mTextHeight + mOutSideRadius + mCircumRadius);
            valCompare = 360 - val;
            mCanvas.drawArc(rectF3, -95, -valCompare, false, mAnglePaint);
        }
    ...
    private void drawCompassOutSide() {
        ...
        RectF rectF1 = new RectF(width / 2 - mOutSideRadius, mTextHeight, width / 2 + mOutSideRadius, mTextHeight + mOutSideRadius * 2);
        RectF rectF2 = new RectF(width / 2 - mOutSideRadius, mTextHeight, width / 2 + mOutSideRadius, mTextHeight + mOutSideRadius * 2);
        RectF rectF3 = new RectF(width / 2 - mOutSideRadius, mTextHeight, width / 2 + mOutSideRadius, mTextHeight + mOutSideRadius * 2);
        RectF rectF4 = new RectF(width / 2 - mOutSideRadius, mTextHeight, width / 2 + mOutSideRadius, mTextHeight + mOutSideRadius * 2);
        mCanvas.drawArc(rectF1, -80, 120, false, mLightGrayPaint);
        mCanvas.drawArc(rectF2, 40, 20, false, mDeepGrayPaint);
        mCanvas.drawArc(rectF3, -100, -20, false, mLightGrayPaint);
        mCanvas.drawArc(rectF4, -120, -120, false, mDarkRedPaint);
        mCanvas.restore();
    }
